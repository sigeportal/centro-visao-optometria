  ...
  try
    ...
    try
      ...
      LQuery.SQL.Text :=
        ...
        'C.CON_DATA AS CONSULTA_DATA, C.CON_ORIGEM AS CONSULTA_ORIGEM, C.CON_CRIADO_EM AS CONSULTA_CRIADO_EM, ' +
        'A.ANA_DATA AS DATA, COALESCE(C.CON_CRIADO_EM, A.ANA_DATA) AS CRIADO_EM, C.CON_STATUS AS CONSULTA_STATUS, ' +
        ...
        'ORDER BY COALESCE(C.CON_DATA, A.ANA_DATA) DESC, A.ANA_ID DESC';
  ...
  try
    ...
    try
      ...
      LQuery.SQL.Text :=
        ...
        'CON_ORIGEM AS ORIGEM, CON_CRIADO_EM AS CRIADO_EM, CON_OBSERVACOES AS OBSERVACOES ' +
